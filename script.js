            ...
            if(pipe_sprite_props.right <= 0){
                ...
                if(bird_props.left < pipe_sprite_props.left + pipe_sprite_props.width && bird_props.left + bird_props.width > pipe_sprite_props.left 
                    ...
                    if(score_val.innerHTML < 5) {
                        message.innerHTML = 'You were defeated by the Whomping Willow' + '<br>Press Enter To Try Again';
                        message.classList.add('messageStyle');
                        img.style.display = 'none';
                        sound_die.play();
                    } else{ 
                        message.innerHTML = 'Congrats on defeating the Whomping Willow!' + '<br>Press Enter';
                        //go back to hallway
                        message.classList.add('messageStyle');
                        img.style.display = 'none';
                    }
